...
namespace eve::detail
{
  ...
  div_(EVE_SUPPORTS(cpu_), flx::diff_type<N> const &, T const &a, U const &b) noexcept
      requires compatible_values<T, U>
  {
    return arithmetic_call(flx::diff_type<N>()(div), a, b);
  }
  ...
  EVE_FORCEINLINE auto div_(EVE_SUPPORTS(cpu_), flx::diff_type<N>
