...
namespace eve::detail
{
  ...
  mul_(EVE_SUPPORTS(cpu_), flx::diff_type<N> const &, T const &a, U const &b) noexcept
  requires compatible_values<T, U>
  {
    return arithmetic_call(flx::diff_nth<N>(mul), a, b);
  }
  ...
  auto mul_(EVE_SUPPORTS(cpu_), flx::diff_type<N>
