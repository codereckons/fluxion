...
namespace flx
{
  ...
  struct tgamma_t : eve::elementwise_callable<tgamma_t, Options>
  {
    ...
    flx_CALLABLE_OBJECT(tgamma_t, tgamma_);
  };
...
//!   {
//!      // Regular overload
//!      constexpr auto tgamma(floating_value auto x)   noexcept;
//!   }
//!   @endcode
//!
//!   **Parameters**
...
namespace flx::_
{
  ...
  FLX_FORCEINLINE constexpr auto tgamma_(flx_DELAY(), O const&, Z z) noexcept
  requires(concepts::base<Z> || order_v<Z> == 1)
  {
    auto val= eve::tgamma(e0(z));
