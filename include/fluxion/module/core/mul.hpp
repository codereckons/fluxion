...
namespace flx
{
  ...
  struct mul_t : eve::callable<mul_t, Options>
  {
    ...
    flx_CALLABLE_OBJECT(mul_t, mul_);
  };
...
//!   namespace flx
//!   {
//!      template<concepts::hyperdual_like T0, oncepts::hyperdual_like ... Ts > constexprT mul(T0 z0,  Ts... zs) noexcept;
//!   }
//!   @endcode
//!
//!   **Parameters**
...
namespace flx::_
{
  ...
  FLX_FORCEINLINE constexpr auto mul_(flx_DELAY(), O const&, Z0 z0, Zs... zs) noexcept
  {
    return z0*(zs*...);
  }
}
