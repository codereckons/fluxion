...
namespace flx
{
  ...
  struct sincos_t : eve::elementwise_callable<sincos_t, Options>
  {
    ...
    flx_CALLABLE_OBJECT(sincos_t, sincos_);
};
...
//!   namespace flx
//!   {
//!      template<flx::concepts::hyperdual_like T> constexpr auto sincos(T z) noexcept;
//!   }
//!   @endcode
//!
//!   **Parameters**
...
namespace flx::_
{
  ...
  FLX_FORCEINLINE constexpr auto sincos_(flx_DELAY(), O const&, Z z) noexcept
  {
