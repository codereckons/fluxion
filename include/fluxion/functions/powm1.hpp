...
namespace flx
{
  ...
  struct powm1_t : eve::callable<powm1_t, Options, eve::raw_option>
  {
   template<concepts::hyperdual_like Z0, concepts::hyperdual_like Z1 >
    ...
    flx_CALLABLE_OBJECT(powm1_t, powm1_);
  };
...
//! @{
//!   @var powm1
//!   @brief Computes the  the powm1 operation \f$x^y+1\f$.
//!
...
//!   {
//!     // regular call
//!     constexpr auto powm1(auto z0,  auto z1)  noexcept; //1
//!   }
//!   @endcode
//!
//!   **Parameters**
...
namespace flx::_
{
  ...
  FLX_FORCEINLINE constexpr auto powm1_(flx_DELAY(), O const& o, Z0 x, Z1 y) noexcept
  {
    auto val = eve::powm1[o](e0(x), e0(y));
