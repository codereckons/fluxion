...
namespace flx
{
  ...
  struct reldist_t : eve::strict_elementwise_callable<reldist_t, Options, eve::pedantic_option, eve::numeric_option, internal_option>
  {
    template<concepts::hyperdual_like Z0, concepts::hyperdual_like Z1>
    FLX_FORCEINLINE constexpr auto operator()(Z0 z0, Z1 z1) const noexcept -> decltype(flx::dist(z0, z1))
    {
      return flx_CALL(z0, z1);
    }

    flx_CALLABLE_OBJECT(reldist_t, reldist_);
  };
...
//!     constexpr auto reldist[internal][...](auto z0, auto z1) noexcept;  //4
//!   }
//!   @endcode
//!
//!   **Parameters**
...
namespace flx::_
{
  ...
  FLX_FORCEINLINE constexpr auto reldist_(flx_DELAY(), O const& o, C0 c0,  C1 c1) noexcept
  {
    auto d = flx::dist[o](c0, c1);
    return if_else( flx::is_infinite(d) || flx::is_eqz(d), d, d/flx::max(flx::abs[internal](c0), flx::abs[internal](c1), eve::one(eve::as(abs(c0)))));
  }
}
