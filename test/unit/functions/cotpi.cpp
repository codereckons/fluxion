...
//  auto pr = tts::prec<T>(1.0e-3, 1.0e-7);
  ...
  TTS_ULP_EQUAL(flx::d0(cotpivr), d0, 20.0);
  TTS_ULP_EQUAL(flx::d1(cotpivr), d1, 20.0);
  TTS_ULP_EQUAL(flx::d2(cotpivr), d2, 20.0);
  TTS_ULP_EQUAL(flx::d3(cotpivr), d3, 20.0);
  TTS_ULP_EQUAL(flx::d4(cotpivr), d4, 20.0);
};
