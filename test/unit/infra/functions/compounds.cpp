...
<typename T>(T r, T i, T j, T k, T l, T m, T n, T o)
{
  ...
  {
    h1_t h1p(r*2.0, i*2.0);
    h1_t h1pb(r, i);
    h1pb*= 2.0;
    TTS_EQUAL( h1p , h1pb);
  }
  {
    h1_t h1p(r*2.0f, i*2.0f);
    h1_t h1pb(r, i);
    h1pb*= 2.0f;
    TTS_EQUAL( h1p , h1pb);
  }
  ...
  {
    h2_t h2p(r*2.0, i*2.0);
    h2_t h2pb(r, i);
    h2pb*= 2.0;
    TTS_EQUAL( h2p , h2pb);
  }
  {
    h2_t h2p(r*2.0f, i*2.0f);
    h2_t h2pb(r, i);
    h2pb*= 2.0f;
    TTS_EQUAL( h2p , h2pb);
  }
