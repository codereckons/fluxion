...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::sqr_abs)(T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::sqr_abs)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL( flx::derivative(eve::sqr_abs)(a0), map(dsqr_abs, a0), 0.5);
};
