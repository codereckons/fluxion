...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::derivative(eve::rising_factorial)(T(), T()), T);
  TTS_EXPR_IS(flx::derivative(eve::rising_factorial)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const & a1)
{
  ...
  TTS_RELATIVE_EQUAL(flx::derivative_1st(eve::lrising_factorial)(a0, a1), map(dlrising_factorial1, a0, a1), 5.0e-4);
  TTS_RELATIVE_EQUAL(flx::derivative_2nd(eve::lrising_factorial)(a0, a1), map(dlrising_factorial2, a0, a1), 5.0e-4);
};
