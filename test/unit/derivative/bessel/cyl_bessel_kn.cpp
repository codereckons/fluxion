...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_kn)(T(), T()), T);
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_kn)(v_t(), v_t()), v_t);
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_kn)(i_t(), T()), T);
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_kn)(I_t(), T()), T);
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_kn)(i_t(), v_t()), v_t);
};
...
<typename I,typename T>(I const & i,T const& a0)
{
  ...
  TTS_RELATIVE_EQUAL(flx::derivative_2nd(eve::cyl_bessel_kn)(i, a0), map(dcyl_bessel_kn, i, a0), 1.0e-4);
};
