...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::derivative(eve::cyl_bessel_j0)(T()), T);
  TTS_EXPR_IS(flx::derivative(eve::cyl_bessel_j0)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  auto dcyl_bessel_j0 = [&](auto e) -> v_t{ return boost::math::cyl_bessel_j_prime(0, e); };
  TTS_ULP_EQUAL(flx::derivative_1st(eve::cyl_bessel_j0)(a0), map(dcyl_bessel_j0, a0), 10.);
};
