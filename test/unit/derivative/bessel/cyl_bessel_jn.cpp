...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_jn)(T(), T()), T);
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_jn)(v_t(), v_t()), v_t);
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_jn)(i_t(), T()), T);
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_jn)(I_t(), T()), T);
  TTS_EXPR_IS(flx::derivative_2nd(eve::cyl_bessel_jn)(i_t(), v_t()), v_t);
};
...
<typename I,typename T>(I const & i0,T const& a0)
{
  ...
  TTS_RELATIVE_EQUAL(flx::derivative_2nd(eve::cyl_bessel_jn)(i0, a0), map(dcyl_bessel_jn, i0, a0), 1.0e-4);
};
