...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::log_abs)(T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::log_abs)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::log_abs)(a0), map(dlog_abs, a0), 2.0);
};
