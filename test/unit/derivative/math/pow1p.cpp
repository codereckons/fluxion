...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::pow1p)(T(), T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::pow1p)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::pow1p)(a0, a1), map(dpow1p1, a0, a1), 2.0);
  TTS_ULP_EQUAL(flx::derivative_2nd(eve::pow1p)(a0, a1), map(dpow1p2, a0, a1), 2.0);
