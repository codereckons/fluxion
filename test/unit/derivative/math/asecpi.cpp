...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::asecpi)(T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::asecpi)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::asecpi)(a0), map(dasecpi, a0), 3.0);
};
