...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::powm1)(T(), T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::powm1)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::powm1)(a0, a1), map(dpowm11, a0, a1), 2.0);
  TTS_ULP_EQUAL(flx::derivative_2nd(eve::powm1)(a0, a1), map(dpowm12, a0, a1), 2.0);
