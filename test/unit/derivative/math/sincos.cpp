...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::sincos)(T())  , (kumi::tuple<T, T>) );
  TTS_EXPR_IS( flx::derivative(eve::sincos)(v_t()), (kumi::tuple<v_t, v_t>));
};
...
<typename T>(T const& a0)
{
  ...
  auto [ds, dc] = flx::derivative_1st(eve::sincos)(a0);
