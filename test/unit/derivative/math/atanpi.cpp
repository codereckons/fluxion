...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::atanpi)(T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::atanpi)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::atanpi)(a0), map(datanpi, a0), 2.0);
};
