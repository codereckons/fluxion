...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::diff(eve::erfc_inv)(T()), T);
  TTS_EXPR_IS(flx::diff(eve::erfc_inv)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  auto derfc_inv = [&]( auto e) { return eve::rec(flx::diff(eve::erfc)(eve::erfc_inv(e))); };
  TTS_ULP_EQUAL(flx::diff_1st(eve::erfc_inv)(a0), map(derfc_inv, a0), 2.0);
};
