...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::diff(eve::beta)(T(), T()), T);
  TTS_EXPR_IS(flx::diff(eve::beta)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const & a1)
{
  ...
  TTS_RELATIVE_EQUAL(flx::diff_1st(eve::beta)(a0, a1), map(dbeta1, a0, a1), 1.0e-4);
  TTS_RELATIVE_EQUAL(flx::diff_2nd(eve::beta)(a0, a1), map(dbeta2, a0, a1), 1.0e-4);
};
