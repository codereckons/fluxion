...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::diff(eve::lbeta)(T(), T()), T);
  TTS_EXPR_IS(flx::diff(eve::lbeta)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const & a1)
{
  ...
  TTS_RELATIVE_EQUAL(flx::diff_1st(eve::lbeta)(a0, a1), map(dlbeta1, a0, a1), 1.0e-4);
  TTS_RELATIVE_EQUAL(flx::diff_2nd(eve::lbeta)(a0, a1), map(dlbeta2, a0, a1), 1.0e-4);
};
