...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::atan2pi)(T(), T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::atan2pi)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::atan2pi)(a0, a1), map(datan2pi1, a0, a1), 2.0);
  TTS_ULP_EQUAL(flx::derivative_2nd(eve::atan2pi)(a0, a1), map(datan2pi2, a0, a1), 2.0);
