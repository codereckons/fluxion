...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::logspace_add)(T(), T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::logspace_add)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::logspace_add)(a0, a1), map(dlogspace_add1, a0, a1), 2.0);
  TTS_ULP_EQUAL(flx::derivative_2nd(eve::logspace_add)(a0, a1), map(dlogspace_add2, a0, a1), 2.0);
};
