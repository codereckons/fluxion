...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::asinpi)(T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::asinpi)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::asinpi)(a0), map(dasinpi, a0), 2.0);
};
