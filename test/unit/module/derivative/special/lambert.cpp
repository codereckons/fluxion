...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::derivative(eve::lambert)(T()), (kumi::tuple<T, T>));
  TTS_EXPR_IS(flx::derivative(eve::lambert)(v_t()), (kumi::tuple<v_t, v_t>));
};
...
<typename T>(T const& a0)
{
  ...
  auto [z1, z2] = flx::derivative_1st(eve::lambert)(a0);
