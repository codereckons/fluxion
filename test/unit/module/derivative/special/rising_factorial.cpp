...
<typename T>(T const& a0, T const & a1)
{
  ...
  TTS_RELATIVE_EQUAL(flx::derivative_1st(eve::rising_factorial)(a0, a1), map(drising_factorial1, a0, a1), 6.0e-4);
  TTS_RELATIVE_EQUAL(flx::derivative_2nd(eve::rising_factorial)(a0, a1), map(drising_factorial2, a0, a1), 6.0e-4);
};
