...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::horner)(T(), T(), T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::horner)(v_t(), v_t(), v_t()), v_t);
};
...
<typename T>(T const& x, T const& a0, T const& a1, T const& a2, T const& a3)
{
 ...
 auto dhorner = [&](auto e, auto a, auto b, auto c, auto ) { return c+2*b*e+3*a*e*e; };
  TTS_ULP_EQUAL(flx::derivative_1st(eve::horner)(x, a3, a2, a1, a0), map(dhorner, x, a3, a2, a1, a0), 0.5);
};
