...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::negate)(T(), T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::negate)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL( flx::derivative_1st(eve::negate)(a0, a1), map(dnegate1, a0, a1), 0.5);
  TTS_ULP_EQUAL( flx::derivative_2nd(eve::negate)(a0, a1), map(dnegate2, a0, a1), 0.5);
};
