...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::derivative(eve::dist)(T(), T())  , T  );
  TTS_EXPR_IS( flx::derivative(eve::dist)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL( flx::derivative_1st(eve::dist)(a0, a1), map(ddist1, a0, a1), 0.5);
  TTS_ULP_EQUAL( flx::derivative_2nd(eve::dist)(a0, a1), map(ddist2, a0, a1), 0.5);
};
