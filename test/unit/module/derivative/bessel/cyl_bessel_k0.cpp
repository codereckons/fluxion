...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::derivative(eve::cyl_bessel_k0)(T()), T);
  TTS_EXPR_IS(flx::derivative(eve::cyl_bessel_k0)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::cyl_bessel_k0)(a0), map(dcyl_bessel_k0, a0), 20.);
};
