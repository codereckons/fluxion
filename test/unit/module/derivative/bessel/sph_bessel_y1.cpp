...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::derivative(eve::sph_bessel_y1)(T()), T);
  TTS_EXPR_IS(flx::derivative(eve::sph_bessel_y1)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(flx::derivative_1st(eve::sph_bessel_y1)(a0), map(dsph_bessel_y1, a0), 200);
};
