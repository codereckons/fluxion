...
<typename I,typename T>(I const & i,T const& a0)
{
  ...
  auto dsph_bessel_jn = [&](auto i, auto e) { return boost::math::sph_bessel_prime(i, e); };
  TTS_ULP_EQUAL(flx::diff_1st(eve::sph_bessel_jn)(i, a0), map(dsph_bessel_jn, i, a0), 250);
};
