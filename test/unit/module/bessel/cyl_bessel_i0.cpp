...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS(flx::diff(eve::cyl_bessel_i0)(T()), T);
  TTS_EXPR_IS(flx::diff(eve::cyl_bessel_i0)(v_t()), v_t);
};
...
<typename T>(T const& a0)
{
  ...
  TTS_ULP_EQUAL(flx::diff_1st(eve::cyl_bessel_i0)(a0), map(dcyl_bessel_i0, a0), 1.5);
};
