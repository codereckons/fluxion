...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::diff(eve::negatenz)(T(), T())  , T  );
  TTS_EXPR_IS( flx::diff(eve::negatenz)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL( flx::diff_1st(eve::negatenz)(a0, a1), map(dnegatenz1, a0, a1), 0.5);
  TTS_ULP_EQUAL( flx::diff_2nd(eve::negatenz)(a0, a1), map(dnegatenz2, a0, a1), 0.5);
};
