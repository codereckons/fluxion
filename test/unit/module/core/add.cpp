...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::diff(eve::add)(T(), T())  , T  );
  TTS_EXPR_IS( flx::diff(eve::add)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL( flx::diff_1st(eve::add)(a0, a1), map(dadd, a0, a1), 0.5);
  TTS_ULP_EQUAL( flx::diff_2nd(eve::add)(a0, a1), map(dadd, a0, a1), 0.5);
};
