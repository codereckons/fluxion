...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::diff(eve::legendre)(i_t(), T())  , T);
  TTS_EXPR_IS( flx::diff(eve::legendre)(wi_t(), T())  , T);
  TTS_EXPR_IS( flx::diff(eve::legendre)(i_t(), v_t())  , v_t);
  TTS_EXPR_IS( flx::diff(eve::legendre)(wi_t(), v_t())  , T);
};
