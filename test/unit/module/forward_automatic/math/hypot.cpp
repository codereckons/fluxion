...
//   TTS_IEEE_EQUAL(val(eve::hypot[mask](vda0, a1, a2)), eve::hypot[mask](a0, a1, a2));
//   TTS_IEEE_EQUAL(der(eve::hypot[mask](vda0, a1, a2)), eve::if_else(mask, derivative_1st(eve::hypot)(a0, a1, a2), eve::one));
//   TTS_IEEE_EQUAL(val(eve::hypot[mask](a0, vda1, a2)), eve::hypot[mask](a0, a1, a2));
//   TTS_IEEE_EQUAL(der(eve::hypot[mask](a0, vda1, a2)), eve::if_else(mask, derivative_2nd(eve::hypot)(a0, a1, a2), eve::zero));
//   TTS_IEEE_EQUAL(val(eve::hypot[mask](a0, a1, vda2)), eve::hypot[mask](a0, a1, a2));
//   TTS_IEEE_EQUAL(der(eve::hypot[mask](a0, a1, vda2)), eve::if_else(mask, derivative_3rd(eve::hypot)(a0, a1, a2), eve::zero));
};
