...
//==================================================================================================
// Tests for flx::absmax
//==================================================================================================
TTS_CASE_WITH( "Check behavior of flx::absmax(eve::wide)"
...
//   TTS_EQUAL(der(eve::absmax[mask](a0, vda1, a2))  , eve::if_else(mask, derivative_2nd(eve::absmax)(a0, a1, a2), eve::zero));
//   TTS_EQUAL(der(eve::absmax[mask](a0, a1, vda2))  , eve::if_else(mask, derivative_3rd(eve::absmax)(a0, a1, a2), eve::zero));
};
