...
// Tests for flx::div
//==================================================================================================
TTS_CASE_WITH("Check behavior of flx::div(eve::wide) for real values",
...
<typename T>(T const& w0, T const& w1)
{
  ...
  //  valder + valder
  TTS_EQUAL(wv0 / wv1, var(w0 / w1 , der_div(wv0,wv1)) );
  TTS_EQUAL(wv0 /  sv, var(w0 / s  , der_div(wv0, sv)) );
  TTS_EQUAL(sv  / wv1, var(s  / w1 , der_div(sv ,wv1)) );
  TTS_EQUAL(sv  /  sv, var(s  / s  , der_div(sv,sv)  ) );
...
TTS_CASE_WITH("Check behavior of flx::div(eve::wide) for complex values",
              flx::test::simd::ieee_reals,
              tts::generate(tts::randoms(-10, +10),
                            tts::randoms(-10, +10),
                            tts::randoms(-10, +10)
