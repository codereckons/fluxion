  ...
  <typename T, typename M>(T const& a0, T const& a1, T const& a2, M const& mask)
{
  ...
  TTS_EQUAL(val(eve::mul(a0, vda1    ))      , eve::mul(a0, a1    ));
  ...
  TTS_EQUAL(val(eve::mul[mask](vda0, a1)), eve::mul[mask](a0, a1));
  ...
  der(vda2) = T(0.5);
  TTS_EQUAL(der(eve::mul(a0, vda1, vda2))      , derivative_2nd(eve::mul)(a0, a1, a2)+der(vda2)*derivative_3rd(eve::mul)(a0, a1, a2));
