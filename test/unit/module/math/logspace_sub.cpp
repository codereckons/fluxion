...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(flx::diff_1st(eve::logspace_sub)(a0, a1), map(dlogspace_sub1, a0, a1), 1.0);
  TTS_ULP_EQUAL(flx::diff_2nd(eve::logspace_sub)(a0, a1), map(dlogspace_sub2, a0, a1), 1.0);
};
