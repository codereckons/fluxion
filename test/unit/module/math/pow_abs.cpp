...
<typename T>(tts::type<T>)
{
  ...
  TTS_EXPR_IS( flx::diff(eve::pow_abs)(T(), T())  , T  );
  TTS_EXPR_IS( flx::diff(eve::pow_abs)(v_t(), v_t()), v_t);
};
...
<typename T>(T const& a0, T const& a1)
{
  ...
  TTS_ULP_EQUAL(flx::diff_1st(eve::pow_abs)(a0, a1), map(dpow_abs1, a0, a1), 2.0);
  TTS_ULP_EQUAL(flx::diff_2nd(eve::pow_abs)(a0, a1), map(dpow_abs2, a0, a1), 2.0);
